...
CREATE TABLE `table2` (
  ...
  `user_id` INT(5) NOT NULL, phone_number INT(10) NOT NULL, 
  PRIMARY KEY (`phone_id`), 
  INDEX(`user_id`, `phone_number`));
CREATE TABLE `table3` (
  `room_id` INT(5) NOT NULL AUTO_INCREMENT, 
  `phone_id` INT(5) NOT NULL, `room_number` INT(4) NOT NULL, 
  PRIMARY KEY(`room_id`), INDEX(`phone_id`, `room_number`));
```
...
UPDATE table2 SET user_id='2', phone_number='200' 
WHERE phone_id='1';
DELETE FROM table1 
WHERE user_id = 1; 
